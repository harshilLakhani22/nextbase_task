...
export default function Uploader() {
  ...
  return (
    <div className="p-4 border-2 border-dashed rounded flex flex-col items-center bg-white">
      <input
        ref={inputRef}
        type="file"
        multiple
      ...
      />
      <button
        className="mb-2 px-4 py-2 bg-black text-white rounded"
      ...
      <div
        className="w-full h-24 flex items-center justify-center text-gray-400"
